...
public class LowCreditScore extends BaseClass {
	...
	//initialise null objects for pages files
		...
		@Description("Application page verification begin")
		@Epic("Application Page")
		@Feature("Feature3: Application Page low score process")
		@Severity(SeverityLevel.CRITICAL)
		@Test
	    
	@SuppressWarnings("deprecation")
	public static void LowScoreTest() throws MalformedURLException {
		...
		try {
			...
			FileInputStream fs = new FileInputStream("/Users/sgrover7/eclipse-workspace/ios/src/test/resources/InputFile/LowCreditScore.xlsx");
			...
			for (int j = 1; j <= rowNum; j++) {
				...
				for (int i = 1; i <= noOfsignups; i++) {
					...
					PartialSignupPg.fill_lowScoreSignup();
					...
					// address page
					applicnpg.fill_application_LowScore();
					
					//We are unable to approve messgae
					
					//page title
					applicnpg.chec_experian();
					}
			}
		...
		@AfterMethod
		@Description("Low credit check process end")
		@AfterTest
