...
//Verify Driver should able to re-enter the confirm the password with mentioned conditions
...
public class PasswordPageValidations extends BaseClass {
	...
	//initialise null objects for pages files
		...
		@Description("Password page verification begin")
		@Epic("Password Page")
		@Feature("Feature5: Password Page Validations")
		@Severity(SeverityLevel.CRITICAL)
		@Test
	    @SuppressWarnings("deprecation")
	    public static void PasswordValidations() throws MalformedURLException {
		...
		try {
			...
			FileInputStream fs = new FileInputStream("/Users/sgrover7/eclipse-workspace/ios/src/test/resources/InputFile/PasswordPageValidations.xlsx");
			...
			for (int j = 1; j <= rowNum; j++) {
				...
				for (int i = 1; i <= noOfsignups; i++) {
					...
					//creditcardpg.fill_creditcard_invalid();
					...
					//check create button
					Thread.sleep(6000);
					creditcardpg.create_password_buttonCheck();
		...
		@AfterMethod
		@Description("password page verification end")
		@AfterTest
