...
public class PartialSignupPage extends BaseClass{
	...
	@iOSXCUITFindBy (xpath = "//XCUIElementTypeStaticText[@name=\"Enter a valid First Name\"]")
	public WebElement invalidFN;
	
	@iOSXCUITFindBy (xpath = "//XCUIElementTypeStaticText[@name=\"Enter a valid Last Name\"]")
